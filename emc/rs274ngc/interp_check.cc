...
int Interp::check_other_codes(block_pointer block)       //!< pointer to a block of RS274/NGC instructions
{
  ...
  if (block->e_flag) {
    CHKS(((motion != G_76) && (block->m_modes[5] != 66) && 
      (block->m_modes[5] != 67) && (block->m_modes[5] != 68) && (block->g_modes[1] != G_84) && (block->g_modes[1] != G_83) && (block->g_modes[1] != G_74) && (block->g_modes[1] != G_73)),_("E word with no G76, M66, M67 or M68 to use it"));
  }
  ...
  if (block->k_flag) {    /* could still be useless if xy_plane arc */
    CHKS(((motion != G_2) && (motion != G_3) && (motion != G_33) &&
        (motion != G_33_1) && (motion != G_76) && (motion != G_87)&& (motion != G_86)),
  ...
  if (block->l_number != -1) {
    CHKS((((motion < G_81) || (motion > G_89)) && (motion != G_76) &&
     ...
     (block->m_modes[5] != 66) &&  (block->m_modes[5] != 70)),
  ...
  if (block->p_flag) {
      CHKS(((block->g_modes[0] != G_10) && (block->g_modes[0] != G_4) && (block->g_modes[13] != G_64) &&
          ...
          (motion != G_89) && (motion != G_5) && (motion != G_5_2) && (motion != G_83) && (motion != G_84) &&
          (motion != G_2) && (motion != G_3) && (motion != G_2_1) && (motion != G_2_2)  &&
          ...
          (block->m_modes[5] != 70) && (block->m_modes[5] != 71) && (block->m_modes[5] != 72) && (block->m_modes[5] != 91)
           && (block->user_m != 1) && (block->m_modes[6] != 90) && (block->m_modes[9] != 54) && (block->m_modes[5] != 70)
              && (block->m_modes[7] != 3) && (block->m_modes[7] != 4) && (block->m_modes[7] != 5) && (block->m_modes[8] != 8)),
          _("P word with no G2 G3 G4 G10 G64 G5 G5.2 G76 G82 G86 G88 G89"
            " or M50 M51 M52 M53 M62 M63 M64 M65 M66 M90 or user M code to use it"));
  ...
  if (block->q_number != -1.0) {
      CHKS((motion != G_83) && (motion != G_73) && (motion != G_5) && (block->user_m != 1) && (motion != G_76) &&
          ...
          (block->g_modes[0] != G_10) && (block->m_modes[6] != 61) && (block->g_modes[13] != G_64) && !is_a_cycle(block->motion_to_be)
           && (block->m_modes[6] != 90 &&  (block->m_modes[5] != 70)),
          _("Q word with no G5, G10, G64, G73, G76, G83, M66, M67, M68 or user M code that uses it"));
  }

  if (block->r_flag) {
    CHKS(((motion != G_2) && (motion != G_3) && (motion != G_76) &&
         ((motion < G_81) || (motion > G_89)) && (motion != G_73)  && (motion != G_74) &&
         (block->g_modes[7] != G_41_1) && (block->g_modes[7] != G_42_1) &&
         (block->g_modes[0] != G_10) && (block->g_modes[0] != G_68) && (block->g_modes[0] != G_69)),
        NCE_R_WORD_WITH_NO_G_CODE_THAT_USES_IT);
  }
