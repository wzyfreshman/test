...
extern int sendSpindleFeed(double val);
extern int sendSpindleForward(double val);
...
extern int sendHome(int axis, int flag);
extern int sendUnHome(int axis, int flag = 0);
...
extern int sendProgramRun(int line, int endline=0);
...
extern int sendAutoRepeat(bool val);
extern int sendMdiCmd(const char *mdi, int flag);
extern int sendMdiCmd(const char *mdi,int *ret,int flag);
...
extern int sendSetlefttime(int val);
extern int sendStartLine(int line);
extern int sendWaitSignal(int signal);
extern int sendSetParameter(int index,double val);
extern int sendSetDIO(int io,int flag); //set the dio in program
extern int sendSetExternIO(int io,int flag);
extern int sendSetAnalogyIO(int io,int flag);
extern int iniLoad(const char *filename);
extern int checkStatus();
extern int sendResetcmd(); //hong
extern int sendDoubleZcmd(int axis , int m6_flags, double *z_diff); //ghf-2014/4/2
extern int sendJogwheels_guidecmd(unsigned char status);//ghf-2014/3/12
extern int sendSetgmodecmd(TGMODE *gmode0, TGMODE *gmode1);//ghf-2014/3/12
extern int sendSetlightcmd(unsigned char setlight);//ghf-2014/3/17
extern int sendEncryptcmd(char* encryptbuf);//ghf-2014/3/28
extern int sendFiltertimecmd(char* filtertimebuf);//ghf-2014/5/6
extern int sendProReadOnly(int flag = 1);//hong-2014/04/14
extern int sendParaFlush(); //hong-2014/06/12
extern int sendChoiceDefaultFeed(double dffeed);
extern int sendMultiFunction(int type = 0,int ival = 0,double dval = 0);
