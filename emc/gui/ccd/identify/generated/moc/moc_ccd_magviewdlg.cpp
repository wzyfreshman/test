...
static const char qt_meta_stringdata_CCD_MagViewDlg[] = {
    "CCD_MagViewDlg\0"
};
...
const QMetaObjectExtraData CCD_MagViewDlg::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CCD_MagViewDlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CCD_MagViewDlg,
      qt_meta_data_CCD_MagViewDlg, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CCD_MagViewDlg::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CCD_MagViewDlg))
