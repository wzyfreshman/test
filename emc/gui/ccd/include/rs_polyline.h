...
//#include "rs_camoperation.h"
//#include "rs_graphic.h"

/**
 * Holds the data that defines a polyline.
 */
class CCD_API RS_PolylineData  {
public:
    RS_PolylineData() {
 ...
 */
class CCD_API RS_Polyline : public RS_EntityContainer {
public:
    ...
    //virtual void reparent(RS_EntityContainer *parent1);
