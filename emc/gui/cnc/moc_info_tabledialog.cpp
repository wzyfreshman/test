/****************************************************************************
** Meta object code from reading C++ file 'info_tabledialog.h'
**
...
#include "ui/info_tabledialog.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'info_tabledialog.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 35, 11), // "clear_table"
QT_MOC_LITERAL(4, 47, 16), // "classify_display"
QT_MOC_LITERAL(5, 64, 8) // "showTime"

    },
    "Info_TableDIalog\0insert_info_line\0\0"
    "clear_table\0classify_display\0showTime"
};
...
void Info_TableDIalog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->insert_info_line((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->clear_table(); break;
        case 2: _t->classify_display(); break;
