...
int emcFormat(NMLTYPE type, void *buffer, CMS * cms)
{
    ...
    ((EMC_M99_CMD *) buffer)->update(cms);
    case EMC_PRO_VERIFY_TYPE:
    ((EMC_PRO_VERIFY_CMD *) buffer)->update(cms);
    case EMC_ABORT_TYPE:
    ...
    ((EMC_MOTION_SET_EXTERN_OUT *) buffer)->update(cms);
    break;
    ...
    ((EMC_NULLEVENT *) buffer)->update(cms);
    break;
    ...
    ((EMC_TASK_PLAN_NULL *) buffer)->update(cms);
    break;
    ...
    ((EMC_TASK_SET_LEFTTIME *) buffer)->update(cms);
    break;
    case EMC_TASK_SET_STARTLINE_TYPE:
    ((EMC_TASK_SET_STARTLINE *) buffer)->update(cms);
    break;
    case EMC_TASK_WAIT_FOR_SIGNAL_TYPE:
    ((EMC_TASK_WAIT_FOR_SIGNAL *) buffer)->update(cms);
    break;
    case EMC_TASK_SET_SIGNAL_TYPE:
    ((EMC_TASK_SET_SIGNAL *) buffer)->update(cms);
    break;
    case EMC_TASK_SET_PARAMETER_TYPE:
    ((EMC_TASK_SET_PARAMETER *) buffer)->update(cms);
    break;
    ...
    ((EMC_TASK_FLUSH_PAR *) buffer)->update(cms);
    break;
    case EMC_TASK_AUTOREPEAT_PAR_TYPE:
    ((EMC_TASK_AUTOREPEAT_PAR *) buffer)->update(cms);
    break;
    ...
    ((EMC_TRAJ_MINLINEAR_MOVE *) buffer)->update(cms);
    break;
    ...
    ((EMC_TRAJ_SET_G0_ENABLE *) buffer)->update(cms);
    break;
    case EMC_TRAJ_SET_DEFAULT_FEED_TYPE:
    ((EMC_TRAJ_SET_DEFAULT_FEED *) buffer)->update(cms);
    break;
    case EMC_TRAJ_MULTI_FUNCTION_TYPE:
    ((EMC_TRAJ_MULTI_FUNCTION *) buffer)->update(cms);
    break;
	...
	break;
    case EMC_RESET_CMD_TYPE:
    ((EMC_RESET_CMD *) buffer)->update(cms);
    break;
    case EMC_DOUBLEZ_CMD_TYPE:
	((EMC_DOUBLEZ_CMD *) buffer)->update(cms);
	break;
    case EMC_DOUBLEZ_STAT_TYPE:
	((EMC_DOUBLEZ_STAT *) buffer)->update(cms);
	break;

    case EMC_JOGWHEELS_GUIDE_CMD_TYPE:
	((EMC_JOGWHEELS_GUIDE_CMD *) buffer)->update(cms);
	break;

    case EMC_SETGMODE_CMD_TYPE:
	((EMC_SETGMODE_CMD *) buffer)->update(cms);
	break;
	
    case EMC_SETLIGHT_CMD_TYPE:
	((EMC_SETLIGHT_CMD *) buffer)->update(cms);
	break;
    
    case EMC_ENCRYPT_CMD_TYPE:
	((EMC_ENCRYPT_CMD *) buffer)->update(cms);
	break;
	
    case EMC_FILTERTIME_CMD_TYPE:
	((EMC_FILTERTIME_CMD *) buffer)->update(cms);
	break;
...
const char *emc_symbol_lookup(long type)
{
    ...
    case EMC_MOTION_SET_EXTERN_OUT_TYPE:
    return "EMC_MOTION_SET_EXTERN_OUT";
    case EMC_MOTION_SET_DOUT_TYPE:
    ...
    case EMC_TASK_SET_SIGNAL_TYPE:
    return "EMC_TASK_SET_SIGNAL";
    case EMC_TASK_SET_PARAMETER_TYPE:
    return "EMC_TASK_SET_PARAMETER";
    case EMC_TASK_PLAN_SYNCH_TYPE:
	return "EMC_TASK_PLAN_SYNCH";
    case EMC_TASK_PLAN_NULL_TYPE:
    return "EMC_TASK_PLAN_NULL";
    case EMC_TASK_WAIT_FOR_SIGNAL_TYPE:
    return "EMC_TASK_WAIT_FOR_SIGNAL";
    case EMC_TASK_PLAN_SET_OPTIONAL_STOP_TYPE:
	return "EMC_TASK_PLAN_SET_OPTIONAL_STOP";
    case EMC_TASK_SET_STARTLINE_TYPE:
    return "EMC_TASK_SET_STARTLINE_TYPE";
    case EMC_TASK_PLAN_SET_BLOCK_DELETE_TYPE:
	return "EMC_TASK_PLAN_SET_BLOCK_DELETE";
    case EMC_TASK_SET_LEFTTIME_TYPE:
    return "EMC_TASK_SET_LEFTTIME";
    case EMC_TASK_PLAN_OPTIONAL_STOP_TYPE:
    ...
    case EMC_TASK_FLUSH_PAR_TYPE:
    return "EMC_TASK_FLUSH_PAR";
    case EMC_TASK_AUTOREPEAT_PAR_TYPE:
    return "EMC_TASK_AUTOREPEAT_PAR";
    case EMC_TOOL_ABORT_TYPE:
    ...
    case EMC_TRAJ_SET_G0_ENABLE_TYPE:
    return "EMC_TRAJ_SET_G0_ENABLE";
    case EMC_TRAJ_SET_DEFAULT_FEED_TYPE:
    return "EMC_TRAJ_SET_DEFAULT_FEED";
    case EMC_TRAJ_MULTI_FUNCTION_TYPE:
    return "EMC_TRAJ_MULTI_FUNCTION";
    case EMC_TRAJ_SET_SCALE_TYPE:
    ...
    case EMC_RESET_CMD_TYPE:
    return "EMC_RESET_CMD";
   case EMC_DOUBLEZ_CMD_TYPE:
	return "EMC_DOUBLEZ_CMD";
   case EMC_DOUBLEZ_STAT_TYPE:
	return "EMC_DOUBLEZ_STAT";
   case EMC_JOGWHEELS_GUIDE_CMD_TYPE:
	return "EMC_JOGWHEELS_GUIDE_CMD";
   case EMC_SETGMODE_CMD_TYPE:
	return "EMC_SETGMODE_CMD";
   case EMC_SETLIGHT_CMD_TYPE:
	return "EMC_SETLIGHT_CMD";	
    case EMC_ENCRYPT_CMD_TYPE:
	return "EMC_ENCRYPT_CMD";
    case EMC_FILTERTIME_CMD_TYPE:
	return "EMC_FILTERTIME_CMD";
    default:
	return "UNKNOWN";
	break;
    }
...
void EMC_TOOL_STAT::update(CMS * cms)
{
    ...
    cms->update(toolcompflag);
    cms->update(tooloffsetflag);
    cms->update(toolcompvalue,CANON_POCKETS_MAX);
...
void EMC_TASK_PLAN_NULL::update(CMS * cms)
{
    EMC_TASK_CMD_MSG::update(cms);
}
...
void EMC_TRAJ_MINLINEAR_MOVE::update(CMS *cms)
{
    EMC_TRAJ_CMD_MSG::update(cms);
    cms->update(minlinenum,MAXMINLEN);
    cms->update(minx,MAXMINLEN);
    cms->update(miny,MAXMINLEN);
    cms->update(minz,MAXMINLEN);
    cms->update(mina,MAXMINLEN);
    cms->update(minb,MAXMINLEN);
    cms->update(minc,MAXMINLEN);
    cms->update(minu,MAXMINLEN);
    cms->update(minv,MAXMINLEN);
    cms->update(minw,MAXMINLEN);
    cms->update(vel,MAXMINLEN);
    cms->update(acc,MAXMINLEN);

    cms->update(cmdtype,MAXMINLEN);
    cms->update(center,MAXMINLEN);
    cms->update(normal,MAXMINLEN);
    cms->update(turn,MAXMINLEN);
    cms->update(type,MAXMINLEN);
    cms->update(ini_maxvel,MAXMINLEN);
    cms->update(feed_mode,MAXMINLEN);
    cms->update(mininum);
    cms->update(tool,MAXMINLEN);
    cms->update(gmodetype,MAXMINLEN);
    cms->update(dynamiccomp,MAXMINLEN);
...
void EMC_TRAJ_LINEAR_MOVE::update(CMS * cms)
{
    ...
    cms->update(gmodetype);//ghf-2014/3/22
    cms->update(dynamiccomp);
}
...
void EMC_AXIS_STAT::update(CMS * cms)
{
    ...
    cms->update(secNegLimit);
    cms->update(secPosLimit);
    cms->update(seclimitOffset);
...
void EMC_TRAJ_SET_G0_ENABLE::update(CMS *cms)
{
    EMC_TRAJ_CMD_MSG::update(cms);
    cms->update(mode);
}

void EMC_TRAJ_SET_DEFAULT_FEED::update(CMS *cms)
{
    EMC_TRAJ_CMD_MSG::update(cms);
    cms->update(feed);
}
...
void EMC_TASK_STAT::update(CMS * cms)
{
    ...
    cms->update(parameters,RS274NGC_MAX_PARAMETERS);
    cms->update(feed_rate);
    cms->update(program_running_time);
    cms->update(work_piece);
    cms->update(mdi_running);
    cms->update(handlewheel_enable);
    cms->update(only_reading);
    cms->update(light,3);
    cms->update(tool_comp_side);
    cms->update(autorepeat);
    cms->update(singlecompverify);
    cms->update(timeleft);
    cms->update(setstartline);
    cms->update(runfromline);
    cms->update(runendline);
    cms->update(hardwarecheck);
    cms->update(getcpuid,8);
    cms->update(fpgacheck,5);
    cms->update(lefttimeval);
    cms->update(waitsignal);
    cms->update(toolnow);
    cms->update(waitflag);

    cms->update(rotationModex);
    cms->update(rotationModey);
    cms->update(rotationModez);

    cms->update(needreloadtool);
...
void EMC_NULLEVENT::update(CMS * cms)
{
...
/****hong:execute a block******************/
void EMC_TASK_EXECUTE_BLOCK::update(CMS * cms)
{
    EMC_TASK_CMD_MSG::update(cms);
    cms->update(command,LINELEN);
}

/****hong:flush the parameter when it change******************/
void EMC_TASK_FLUSH_PAR::update(CMS * cms)
{
    EMC_TASK_CMD_MSG::update(cms);
}


void EMC_TASK_AUTOREPEAT_PAR::update(CMS *cms)
{
    EMC_TASK_CMD_MSG::update(cms);
    cms->update(enable);
}
...
void EMC_TASK_SET_LEFTTIME::update(CMS *cms)
{
    EMC_TASK_CMD_MSG::update(cms);
}

void EMC_TASK_SET_STARTLINE::update(CMS *cms)
{
    EMC_TASK_CMD_MSG::update(cms);
}

void EMC_TASK_WAIT_FOR_SIGNAL::update(CMS *cms)
{
    EMC_TASK_CMD_MSG::update(cms);
}

void EMC_TASK_SET_SIGNAL::update(CMS *cms)
{
    EMC_TASK_CMD_MSG::update(cms);
}

void EMC_TASK_SET_PARAMETER::update(CMS *cms)
{
    EMC_TASK_CMD_MSG::update(cms);
}
...
void EMC_TRAJ_MULTI_FUNCTION::update(CMS * cms)
{

    EMC_TRAJ_CMD_MSG::update(cms);
    cms->update(type);
    cms->update(intpar);
    cms->update(doublepar);
...
void EMC_MOTION_SET_EXTERN_OUT::update(CMS *cms)
{
    EMC_MOTION_CMD_MSG::update(cms);
    cms->update(index);
    cms->update(status);
...
void EMC_RESET_CMD::update(CMS *cms)
{
    EMC_RESET_CMD_MSG::update(cms);
}

void EMC_RESET_CMD_MSG::update(CMS *cms)
{

}

void EMC_DOUBLEZ_CMD::update(CMS *cms)
{
    EMC_DOUBLEZ_CMD_MSG::update(cms);
}

void EMC_DOUBLEZ_CMD_MSG::update(CMS *cms)
{
    
}
//hong-2014/04/19

void EMC_PRO_VERIFY_CMD::update(CMS *cms)
{
    EMC_PRO_VERIFY_CMD_MSG::update(cms);
}

void EMC_PRO_VERIFY_CMD_MSG::update(CMS *cms)
{

}

//hong-2014/04/15
void EMC_M99_CMD::update(CMS *cms)
{
    EMC_M99_CMD_MSG::update(cms);
}

void EMC_M99_CMD_MSG::update(CMS *cms)
{

}
//ghf-2014/3/11
void EMC_JOGWHEELS_GUIDE_CMD::update(CMS *cms)
{
    EMC_JOGWHEELS_GUIDE_CMD_MSG::update(cms);
}

void EMC_JOGWHEELS_GUIDE_CMD_MSG::update(CMS *cms)
{
    
}

void EMC_SETGMODE_CMD::update(CMS *cms)
{
    EMC_SETGMODE_CMD_MSG::update(cms);
}

void EMC_SETGMODE_CMD_MSG::update(CMS *cms)
{
    
}

void EMC_SETLIGHT_CMD::update(CMS *cms)
{
    EMC_SETLIGHT_CMD_MSG::update(cms);
}

void EMC_SETLIGHT_CMD_MSG::update(CMS *cms)
{
    
}

void EMC_ENCRYPT_CMD::update(CMS *cms)
{
    EMC_ENCRYPT_CMD_MSG::update(cms);
}

void EMC_ENCRYPT_CMD_MSG::update(CMS *cms)
{
    
}


void EMC_FILTERTIME_CMD::update(CMS *cms)
{
    EMC_FILTERTIME_CMD_MSG::update(cms);
}

void EMC_FILTERTIME_CMD_MSG::update(CMS *cms)
{
...
void EMC_DOUBLEZ_STAT::update(CMS *cms)
{
    EMC_DOUBLEZ_STAT_MSG::update(cms);
}

void EMC_DOUBLEZ_STAT_MSG::update(CMS *cms)
{
