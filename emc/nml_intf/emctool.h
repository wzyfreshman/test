...
#define CANON_TOOL_ARRAY_MAX 2  //max array number is CANON_TOOL_ARRAY_MAX*CANON_TOOL_ARRAY_MAX
...
struct CANON_TOOL_TABLE {
    ...
    double backangle;
    int orientation;
    double arrayrow[CANON_TOOL_ARRAY_MAX];
    double arraycolumn[CANON_TOOL_ARRAY_MAX];
};
