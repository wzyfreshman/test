...
static RCS_CMD_CHANNEL *emcCommandChannel1 = NULL;
static RCS_STAT_CHANNEL *emcStatusChannel1 = NULL;
static NML *emcErrorChannel1 = NULL;

static RCS_CMD_CHANNEL *toolCommandChannel = NULL;
static RCS_STAT_CHANNEL *toolStatusChannel = NULL;
static RCS_CMD_CHANNEL *toolCommandChannel1 = NULL;
static RCS_STAT_CHANNEL *toolStatusChannel1 = NULL;
...
int main(int argc, char *argv[])
{
    ...
    if (NULL == emcCommandChannel) {
        ...
        emcCommandChannel =
        new RCS_CMD_CHANNEL(emcFormat, "emcCommand0", "emcsvr",
                    EMC_NMLFILE);
        emcCommandChannel1 =
        new RCS_CMD_CHANNEL(emcFormat, "emcCommand1", "emcsvr",
                    EMC_NMLFILE);
    ...
    if (NULL == emcStatusChannel) {
        ...
        emcStatusChannel =
        new RCS_STAT_CHANNEL(emcFormat, "emcStatus0", "emcsvr",
                     EMC_NMLFILE);
        emcStatusChannel1 =
        new RCS_STAT_CHANNEL(emcFormat, "emcStatus1", "emcsvr",
                     EMC_NMLFILE);
    }
    if (NULL == emcErrorChannel) {
        emcErrorChannel =
        new NML(nmlErrorFormat, "emcError0", "emcsvr", EMC_NMLFILE);
        emcErrorChannel1 =
        new NML(nmlErrorFormat, "emcError1", "emcsvr", EMC_NMLFILE);
    }
    if (NULL == toolCommandChannel) {
        toolCommandChannel =
        new RCS_CMD_CHANNEL(emcFormat, "toolCmd0", "emcsvr",
                    EMC_NMLFILE);
        toolCommandChannel1 =
        new RCS_CMD_CHANNEL(emcFormat, "toolCmd1", "emcsvr",
                    EMC_NMLFILE);
    }
    if (NULL == toolStatusChannel) {
        toolStatusChannel =
        new RCS_STAT_CHANNEL(emcFormat, "toolSts0", "emcsvr",
                     EMC_NMLFILE);
        toolStatusChannel1 =
        new RCS_STAT_CHANNEL(emcFormat, "toolSts1", "emcsvr",
                     EMC_NMLFILE);
    }
    ...
    if (!emcCommandChannel1->valid()) {
        delete emcCommandChannel1;
        emcCommandChannel1 = NULL;
    }
    if (!emcStatusChannel1->valid()) {
        delete emcStatusChannel1;
        emcStatusChannel1 = NULL;
    }
    if (!emcErrorChannel1->valid()) {
        delete emcErrorChannel1;
        emcErrorChannel1 = NULL;
    }
    ...
    if (!toolCommandChannel1->valid()) {
        delete toolCommandChannel1;
        toolCommandChannel1 = NULL;
    }
    if (!toolStatusChannel1->valid()) {
        delete toolStatusChannel1;
        toolStatusChannel1 = NULL;
    }
    esleep(0.200);
    }
    ...
    if (NULL == toolCommandChannel1) {
    toolCommandChannel1 =
        new RCS_CMD_CHANNEL(emcFormat, "toolCmd1", "emcsvr",
                EMC_NMLFILE);
    }
    if (NULL == toolStatusChannel1) {
    toolStatusChannel1 =
        new RCS_STAT_CHANNEL(emcFormat, "toolSts1", "emcsvr",
                 EMC_NMLFILE);
    }
