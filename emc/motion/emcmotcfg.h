...
#define EMCMOT_MAX_UINIO 50
#define EMCMOT_MAX_UOUTIO 50
#define EMCMOT_MAX_UWARNIO 50

#define EMCMOT_MAX_USR_OUTIO 100
#define EMCMOT_MAX_USR_INIO 120
#define EMCMOT_MAX_USR_WARNIO 50

#define EMCMOT_MAX_SAVEPOS 100000
...
#define DEFAULT_TC_QUEUE_SIZE 10000

/* max following error */
#define DEFAULT_MAX_FERROR 100

/* max number pass from task to segmentqueue,use for get the realtime status value while running */
