...
Module {
    ...
    version: "5.11.3"
    property stringList architectures: ["arm_64"]
    ...
    property string libFilePathRelease: "/usr/lib/aarch64-linux-gnu/libQt5Core.so.5.11.3"
    ...
    cpp.includePaths: {
        var paths = ["/usr/include/aarch64-linux-gnu/qt5", "/usr/include/aarch64-linux-gnu/qt5/QtCore"];
