...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/usr/lib/aarch64-linux-gnu/libQt5Qml.so.5.11.3"
    cpp.defines: ["QT_QML_LIB"]
    cpp.includePaths: ["/usr/include/aarch64-linux-gnu/qt5", "/usr/include/aarch64-linux-gnu/qt5/QtQml"]
    cpp.libraryPaths: []
    Group {
